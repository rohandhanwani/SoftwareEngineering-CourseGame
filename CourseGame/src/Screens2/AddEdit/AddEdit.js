...
class AddEdit extends Component {
  constructor() {
    ...
    this.state = {
      ...
      quiz_list: [
        { quizName: "Add Assignment", description: "Add assignment to your software" },
        { quizName: "Edit Assignment", description: "Edit Assignment to your software" }
              ...
              >
                <div className="card" style={{ width: "18rem" }}>
                  ...
                  <div className="card-body">
                    ...
                    <p>Total Time: {test.total_time / 60} Minutes</p>
                    <button
  ...
  render() {
    ...
    return (
      <div>
        {renderSelectedTestObj ? (
          <QuizList add={this.state.add} edit={this.state.edit} f={this.changeback} />
        ) : renderMCQs ? (
          <MCQs
